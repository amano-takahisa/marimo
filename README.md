...
git rebase --interactive --autostash --keep-empty --no-autosquash --rebase-merges 3c5379688ed8ab34623b8971dd52908da7140a24
...
```pixi.toml
[pypi-dependencies]
marimo = { path = "/path/to/amano-takahisa/marimo", editable = true }
```

Run `make fe && make py` whenever you make changes to the marimo source code.
